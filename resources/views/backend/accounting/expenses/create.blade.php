...
<div style="display:flex;align-items:center;gap:12px;margin-bottom:20px">
    ...
    <div style="flex:1">
        <h2 style="margin:0;font-size:20px;font-weight:700;color:#303030">Add Expense</h2>
        <p style="margin:0;font-size:12px;color:#999">Record a new business expense</p>
    </div>
...
<form action="{{ route('backend.admin.expenses.store') }}" method="post">
    @csrf
